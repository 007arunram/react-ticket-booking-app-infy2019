  ...
  render() {
    ...
    return (
      <div className="BookingDetails BookingSummary">
        <div className="movieHeader">Booking Summary</div>
        <br />
        <div className="selected_details">
          You have selected following details
        </div>
        <div className="summary_details">
          <div>
            <b>Theater Name</b> :{' '}
            <span>{this.props.cart.selected_theater}</span>
          </div>
          <div>
            <b>Seats Booked</b> : <span>{this.props.cart.seats}</span>
          </div>
          <div>
            <b>Movie Name</b> : <span>{this.props.cart.movie_name}</span>
          </div>
          <div>
            <b>Price</b> : <span>Rs. {this.props.cart.total}</span>
          </div>
          <div>
            <b>Location</b> : <span>{location}</span>
          </div>
          <div>
            <b>Show Date</b> : <span>{this.props.cart.date}</span>
          </div>
          <div>
            <b>Show Time</b> : <span>{this.props.cart.time}</span>
          </div>
