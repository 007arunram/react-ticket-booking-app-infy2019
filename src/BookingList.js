  ...
  render() {
    return (
      <div className="BookingDetails">
        <div className="movieHeader">Booking Details</div>
        <br />
        <div className="moviebody">
          ...
          <div>
            {this.props.data.theater &&
              this.props.data.theater.map((theater) => {
                return (
                  <div key={theater}>
                    <input
                      type="radio"
                      onClick={() => this.selectTheater(theater)}
                    />
                    {theater}
                  </div>
                );
          ...
          <br />
          {this.state.selected_theater && (
            <div>
              <div className="date">
                <b>Selected Theater</b> :{' '}
                <span>{this.state.selected_theater}</span>
                <br />
              </div>
              <div className="date">
                <b>Date</b>
