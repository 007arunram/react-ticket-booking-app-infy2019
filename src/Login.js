...
class Login extends React.Component {
  ...
  render() {
    return (
      <div>
        {this.props.errorMsg && this.props.errorMsg.msg && (
          <div className="ErrorMsg">{this.props.errorMsg.msg}</div>
        )}
        <div className="BookingDetails BookingSummary">
          <div className="movieHeader">Login</div>
          <div className="loginCont">
            <p>
              CTS Movie is an online application where you can tickets for your
              favourite movie. Please login to the application to grab your
              movie ticket.
            </p>
            <div>
              Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:{' '}
            ...
            <div>
              Password : <input type="password" ref={this.pwd} />
            </div>

            <div>
              <button className="Login" onClick={() => this.submitUser()}>
                Login
              </button>
            </div>
          </div>
